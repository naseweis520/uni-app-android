...
import de.unisaarland.UniApp.map.uihelper.CategoryIconCache;
import de.unisaarland.UniApp.utils.UpNavigationActionBarActivity;

public class MapSearchActivity extends UpNavigationActionBarActivity {
    ...
    private class CampusCategoriesAdapter extends BaseAdapter {
        ...
        private final View.OnClickListener categoryClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View view = layoutInflater.inflate(R.layout.map_poi_layout, null);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null)
                convertView = View.inflate(context, R.layout.map_categories_row, null);
    ...
    private class CategoriePOIsAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null)
                convertView = View.inflate(context, R.layout.map_poi_detailed_row, null);

            PointOfInterest poi = pois.get(position);
            TextView categoryTitle = convertView.findViewById(R.id.poi_title);
